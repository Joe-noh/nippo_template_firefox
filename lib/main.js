  ...
  onClick: function () {
    ...
    tabs.open({
      ...
      onReady: function (tab) {
        ...
        var tagsInput  = doc.getElementById('entry_form_tag');

        var ymd = (new Date()).toLocaleDateString();
        titleInput.value = "【日報】"+" "+ymd+" "+pref.prefs.username;
        bodyInput.value  = pref.prefs.template;
        tagsInput.value  = pref.prefs.tags;
      }
    });
  }
});
