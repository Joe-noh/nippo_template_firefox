  ...
  onClick: function () {
    ...
    tabs.open({
      ...
      onReady: function (tab) {
        ...
        doc.getElementById('entry_form_title'      ).value = pref.prefs.username;
        doc.getElementById('entry_form_description').value = pref.prefs.template;
        doc.getElementById('entry_form_tag'        ).value = pref.prefs.tags;
      }
    });
  }
});
